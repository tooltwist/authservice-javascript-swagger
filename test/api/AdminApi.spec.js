...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Authservice.AdminApi();
  });
  ...
  describe('AdminApi', function() {
    describe('routeHealthcheck', function() {
      it('should call routeHealthcheck successfully', function(done) {
        //uncomment below and update the code to test routeHealthcheck
        //instance.routeHealthcheck(function(error) {
