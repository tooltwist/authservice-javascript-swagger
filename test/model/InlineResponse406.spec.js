...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Authservice.InlineResponse406();
  });
  ...
  describe('InlineResponse406', function() {
    it('should create an instance of InlineResponse406', function() {
      // uncomment below and update the code to test InlineResponse406
      //var instane = new Authservice.InlineResponse406();
      //expect(instance).to.be.a(Authservice.InlineResponse406);
    });
