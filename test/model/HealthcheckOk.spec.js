...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Authservice.HealthcheckOk();
  });
  ...
  describe('HealthcheckOk', function() {
    it('should create an instance of HealthcheckOk', function() {
      // uncomment below and update the code to test HealthcheckOk
      //var instane = new Authservice.HealthcheckOk();
      //expect(instance).to.be.a(Authservice.HealthcheckOk);
    });
