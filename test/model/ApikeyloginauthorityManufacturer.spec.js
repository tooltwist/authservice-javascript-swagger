...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Authservice.ApikeyloginauthorityManufacturer();
  });
  ...
  describe('ApikeyloginauthorityManufacturer', function() {
    it('should create an instance of ApikeyloginauthorityManufacturer', function() {
      // uncomment below and update the code to test ApikeyloginauthorityManufacturer
      //var instane = new Authservice.ApikeyloginauthorityManufacturer();
      //expect(instance).to.be.a(Authservice.ApikeyloginauthorityManufacturer);
    });
